...
- **Global scope**: `/home/marc/Development/spin/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/marc/Development/spin/.claude/notes/`)
...
2. Glob `/home/marc/Development/spin/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/marc/Development/spin/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/marc/Development/spin/.claude/notes/` — works in any directory
