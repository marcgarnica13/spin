...
Reference full template: `/home/marc/Development/spin/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/marc/Development/spin/.claude/get-shit-done/templates/state.md`.
